...
func (p *Policy) Check(req Request) Decision {
	// TODO: implement the decision ladder.
	//
	// The starter allows everything, which is exactly the bug you are here to
	// fix: an authorization function that never says no. Every deny case in
	// authz/policy_test.go is currently red.
	return Decision{Allow: true, Reason: "TODO: not implemented"}
}
...
func (p *Policy) CheckRoute(sub Subject, action Action) Decision {
	// TODO: implement in terms of Check — do not restate the rule ladder.
	return Decision{Allow: true, Reason: "TODO: not implemented"}
}
...
func (p *Policy) Allows(sub Subject, action Action, res Resource) bool {
	// TODO: one line, in terms of Check.
	return true
}
