...
func Map[T, U any](s []T, f func(T) U) []U {
	// TODO: implement per acceptance criterion 1.
	return nil
}

// Filter returns the elements of s for which keep returns true, in order.
func Filter[T any](s []T, keep func(T) bool) []T {
	// TODO: implement per acceptance criterion 2.
	return nil
}
...
func IndexOf[T comparable](s []T, target T) int {
	// TODO: implement per acceptance criterion 3.
	return -1
}

// Sum returns the total of all elements of s.
func Sum[T Number](s []T) T {
	// TODO: implement per acceptance criterion 4.
	var zero T
	return zero
}
...
func DescribeAll[T fmt.Stringer](s []T) []string {
	// TODO: implement per acceptance criterion 5.
	return nil
}
