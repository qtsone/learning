...
- [x] **M6 — measured.** The tagged listing has a committed baseline, one
      indexed optimization, and a before/after write-up in PERF.md whose claims
      state the size and selectivity they hold at.
